        ...
        if info.get('thumbnail'):
            try:
                ...
                if preview_url:
                    ...
                    <p style="text-align:center; color:#333; font-size:0.9em; margin-top:6px; font-weight:500;">Video Preview</p>
                    """, unsafe_allow_html=True)
                else:
                    st.markdown(f"""
                    <div class="preview-wrap">
                    ...
                    <p style="text-align:center; color:#333; font-size:0.9em; margin-top:6px; font-weight:500;">Video Thumbnail (Preview not available)</p>
                    """, unsafe_allow_html=True)
            except:
